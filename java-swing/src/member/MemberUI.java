...
//		this.setTitle("회원관리");
		...
		// 값을 입력받거나 표시할 텍스트 필드
		txtName = new JTextField(8);		// 8글자허용
		...
		container.add(new JLabel("테이블 데모 프로그램", JLabel.CENTER),BorderLayout.NORTH);
